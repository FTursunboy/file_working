...
class ProductList
{
    ...
    private function loadProducts()
    {
        if (!empty($this->filename) && file_exists($this->filename)) {
            ...
            echo "Файл '$this->filename' не найден хотите создать его." . PHP_EOL;
                ...
                case '1':
                    ...
                    if ($extension === 'txt') {
                        if (touch($this->filename)) {
                            echo "Файл '$this->filename' успешно создан.";
                        } else {
    ...
    public function subtractTotalPrice()
    {
        ...
        echo "Общая сумма: $totalPrice" . PHP_EOL;
    }
    public function displayProducts()
    {
        echo "Список продуктов:" . PHP_EOL;

        foreach ($this->products as $index => $product) {
            echo "ID: " . ($index + 1) . PHP_EOL;
            echo "Наименование: " . $product['name'] . PHP_EOL;
    ...
    public function run()
    {
        ...
        while (true) {
            ...
            echo "Выберите действие:" . PHP_EOL;
            echo "1 - Добавить в список" . PHP_EOL;
